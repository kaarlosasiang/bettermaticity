...
export default function InfoBar() {
  ...
  return (
    <div
      className="bg-[#00184d] text-[0.6875rem] font-normal tracking-[0.01em] text-white"
      role="complementary"
      aria-label="Real-time information"
    >
      <Container>
        <div
          className="flex flex-wrap items-center justify-end gap-6 py-1.5"
          aria-live="polite"
          aria-atomic="false"
        >
          <span className="inline-flex items-center gap-1.5" aria-label="Exchange rates">
            <ArrowLeftRight className="size-3 text-[#ff0]" aria-hidden="true" />
            {rate}
          </span>
          <span className="inline-flex items-center gap-1.5" aria-label="Current weather in Mati">
            <Thermometer className="size-3 text-[#ff0]" aria-hidden="true" />
            Mati {temp}
          </span>
          <span className="inline-flex items-center gap-1.5" aria-label="Philippine date and time">
