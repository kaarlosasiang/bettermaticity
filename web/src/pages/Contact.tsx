...
const contactCards: {
  ...
  {
    Icon: Mail,
    href: 'mailto:lgumatinv@gmail.com',
    titleKey: 'contact-email',
    value: 'lgumatinv@gmail.com',
    noteKey: 'contact-response',
  },
  {
    Icon: Smartphone,
    href: 'tel:09175951931',
    titleKey: 'contact-mobile',
    value: '0917-595-1931',
    noteKey: 'contact-hours',
  },
  {
    Icon: Phone,
    href: 'tel:0878053581',
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {contactCards.map((c) => (
              <a
                key={c.titleKey}
                href={c.href}
                className="flex overflow-hidden rounded-xl bg-white shadow-[0_0_0_1px_rgba(18,60,122,0.07)] text-foreground no-underline transition hover:-translate-y-0.5 hover:shadow-sm"
              >
              ...
              {[
                {
                  ...
                  Icon: CircleCheck,
                  status: t('contact-open'),
                  tone: 'text-brand-success',
                },
                {
                  day: t('contact-lunch-break'),
                  time: '12:00 PM - 1:00 PM',
                  Icon: CirclePause,
                  status: t('contact-break'),
                  tone: 'text-brand-accent',
                },
                {
                  day: 'Saturday & Sunday',
                  time: t('contact-closed'),
                  Icon: CircleX,
                  status: t('contact-closed'),
                  tone: 'text-destructive',
                },
                {
                  day: t('contact-national-local-holidays'),
                  time: t('contact-closed'),
                  Icon: CircleX,
                  status: t('contact-closed'),
                  tone: 'text-destructive',
                ...
                <div
                  key={i}
                  className="flex flex-col items-center gap-1 border-border p-6 text-center not-last:border-r [&:not(:nth-child(1))]:border-t sm:[&:nth-child(2)]:border-t-0 lg:border-t-0"
                >
                  <span className="text-sm font-semibold text-foreground">{o.day}</span>
                  <span className="text-sm text-muted-foreground">{o.time}</span>
                  <span
                    className={`mt-1 inline-flex items-center gap-1 text-xs font-medium ${o.tone}`}
                  >
