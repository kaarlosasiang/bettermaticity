        ...
        <Container>
          <div className="grid grid-cols-1 gap-2.5 sm:grid-cols-2 md:grid-cols-4">
            ...
            <div className="rounded-lg border border-border bg-card p-3 text-center">
              ...
              <p className="m-0 text-[0.8125rem] font-semibold text-foreground">{t('gs-8am-5pm')}</p>
            </div>
            <div className="rounded-lg border border-border bg-card p-3 text-center">
            ...
            <div>
              ...
              >
                ...
                <DataTable
                  ...
                  rows={[
                    [t('gs-dump-truck'), t('gs-government-plate'), <RateBadge>₱2,500/day</RateBadge>, t('gs-assigned-driver')],
                    [t('gs-backhoe-loader'), t('gs-government-plate'), <RateBadge>₱3,500/day</RateBadge>, t('gs-assigned-operator')],
                    [t('gs-service-vehicle-van'), t('gs-government-plate'), <RateBadge>₱1,500/day</RateBadge>, t('gs-assigned-driver')],
                    [t('gs-ambulance'), t('gs-government-plate'), <RateBadge>{t('gs-free-emergency')}</RateBadge>, t('gs-emtdriver')],
                    [t('gs-motorcycle'), t('gs-government-plate'), <RateBadge>₱500/day</RateBadge>, t('gs-selfdrive')],
                  ]}
                />
                <h4 className="mt-4 text-sm font-semibold text-foreground">
                  {t('gs-rental-process')}
                ...
                <DataTable
                  headers={[t('gs-step'), t('gs-requirements'), t('gs-time'), t('gs-person-responsible')]}
                  rows={[
                    [
                      <span><StepNum n={1} />Submit Request Letter</span>,
                      t('gs-request-letter-addressed-to-the-municipal-mayor'),
                      <TimeBadge>{t('gs-5-mins')}</TimeBadge>,
                      <span><strong className="text-foreground">{t('gs-gso-staff')}</strong><br /><span className="text-xs">{t('gs-receiving-clerk')}</span></span>,
                    ],
                    [
                      <span><StepNum n={2} />Approval of Request</span>,
                      t('gs-wait-for-approval-from-the-mayors-office'),
                      <TimeBadge>{t('gs-12-days')}</TimeBadge>,
                      <span><strong className="text-foreground">{t('gs-mayors-office')}</strong><br /><span className="text-xs">{t('gs-executive-assistant')}</span></span>,
                    ],
                    [
                      <span><StepNum n={3} />Pay Rental Fee</span>,
                      t('gs-order-of-payment-from-gso'),
                      <TimeBadge>{t('gs-10-mins')}</TimeBadge>,
                      <span><strong className="text-foreground">{t('gs-municipal-treasurer')}</strong><br /><span className="text-xs">{t('gs-collection-officer')}</span></span>,
                    ],
                    [
                      <span><StepNum n={4} />Get Trip Ticket</span>,
                      t('gs-official-receipt-approved-request'),
                      <TimeBadge>{t('gs-5-mins')}</TimeBadge>,
                      <span><strong className="text-foreground">{t('gs-gso-head')}</strong><br /><span className="text-xs">{t('gs-general-services-officer')}</span></span>,
                    ],
                  ]}
                />
              </SectionCard>
              ...
              >
                ...
                <DataTable
                  headers={[t('gs-equipment'), t('gs-capacityspecs'), t('gs-rental-rate'), t('gs-operator')]}
                  rows={[
                    [t('gs-road-grader'), t('gs-heavy-duty'), <RateBadge>₱4,000/day</RateBadge>, t('gs-assigned-operator')],
                    [t('gs-road-roller'), t('gs-compactor'), <RateBadge>₱3,000/day</RateBadge>, t('gs-assigned-operator')],
                    [t('gs-water-truck'), t('gs-5000-liters'), <RateBadge>₱2,000/day</RateBadge>, t('gs-assigned-driver')],
                    [t('gs-generator-set'), t('gs-various-kva'), <RateBadge>₱1,500/day</RateBadge>, t('gs-selfoperate')],
                    [t('gs-grass-cutter'), t('gs-industrial'), <RateBadge>₱300/day</RateBadge>, t('gs-selfoperate')],
                  ]}
                />
              ...
              >
                ...
                <DataTable
                  ...
                  rows={[
                    [<strong className="text-foreground">{t('gs-gso-head')}</strong>, t('gs-general-services-officer'), t('gs-department-head')],
                    [t('gs-administrative-staff'), t('gs-administrative-aide'), t('gs-recordsclerical')],
                    [t('gs-property-custodian'), t('gs-administrative-aide'), t('gs-property-management')],
                  ]}
                />
                <h4 className="mt-4 text-sm font-semibold text-foreground">
              ...
              >
                ...
                <DataTable
                  ...
                  rows={[
                    [<StepNum n={1} />, t('gs-submission-of-purchase-request-pr-from-requesting'), <TimeBadge>{t('gs-1-day')}</TimeBadge>],
                    [<StepNum n={2} />, t('gs-review-and-certification-of-availability-of-funds'), <TimeBadge>{t('gs-12-days')}</TimeBadge>],
                    [<StepNum n={3} />, t('gs-canvassrequest-for-quotation-from-suppliers'), <TimeBadge>{t('gs-35-days')}</TimeBadge>],
                    [<StepNum n={4} />, t('gs-abstract-of-quotations-and-award'), <TimeBadge>{t('gs-12-days')}</TimeBadge>],
                    [<StepNum n={5} />, t('gs-issuance-of-purchase-order-po'), <TimeBadge>{t('gs-1-day')}</TimeBadge>],
                    [<StepNum n={6} />, t('gs-delivery-and-inspection'), <TimeBadge>{t('gs-varies')}</TimeBadge>],
                    [<StepNum n={7} />, t('gs-payment-processing'), <TimeBadge>{t('gs-35-days')}</TimeBadge>],
                  ]}
                />
                <h4 className="mt-4 text-sm font-semibold text-foreground">
                ...
                <ul className="m-0 list-none space-y-3 p-0 text-sm">
                  <li className="flex gap-2">
                    ...
                    <span className="flex flex-col">
                      <strong className="text-foreground">{t('gs-general-services-officer')}</strong>
