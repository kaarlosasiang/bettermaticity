...
const leadership: { titleKey: string; nameKey: string; email: string }[] = [
  { titleKey: 'title-mayor', nameKey: 'home-hon-philip-a-dacayo', email: 'mayor@mati.gov.ph' },
  { titleKey: 'title-vice-mayor', nameKey: 'home-hon-eduardo-d-tiongson', email: 'vicemayor@mati.gov.ph' },
];
          ...
          <div className="grid items-center gap-10 lg:grid-cols-2">
            ...
            <div className="rounded-xl bg-white p-6 shadow-lg">
              ...
              <div className="mt-4 flex flex-wrap items-center gap-2 text-xs text-muted-foreground">
                ...
                <AppLink to="/service-details/property-declaration" className="rounded-full bg-muted px-3 py-1 text-primary">{t('home-real-property-tax')}</AppLink>
              </div>
            </div>
          </div>
        </Container>
        ...
        <Container>
          ...
          <div className="grid gap-6 lg:grid-cols-3">
            <div className="flex flex-col items-center justify-center rounded-xl border border-border bg-card p-8 text-center">
              ...
              <span className="mt-1 text-sm text-muted-foreground">Mati, Davao Oriental</span>
            </div>
            ...
            {leadership.map((l) => (
              <div key={l.titleKey} className="flex items-center gap-4 rounded-xl border border-border bg-card p-6">
                ...
                <div>
                  ...
                  <a href={`mailto:${l.email}`} className="text-sm text-muted-foreground hover:text-primary">{l.email}</a>
                </div>
              </div>
            ))}
          </div>
