/**
 * Weather & Map Section for Better Mati Homepage
 * Displays real-time weather data and interactive map of Mati, Davao Oriental
  ...
  const WeatherUI = {
    render(container, data) {
      ...
      try {
        ...
        container.innerHTML = `
                <div class="weather-widget" role="region" aria-label="Current weather in Mati">
                    <div class="weather-current">
                        ...
                        <div class="weather-current-info">
                            ...
                            <div class="weather-current-location">
                                <i class="bi bi-geo-alt" aria-hidden="true"></i> Mati, Davao Oriental
                            </div>
                        </div>
                    </div>
