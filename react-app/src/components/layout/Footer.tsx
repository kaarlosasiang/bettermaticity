        ...
        <div className="footer-main-new">
          <div className="footer-brand">
            ...
            <div className="footer-social-new">
              <a
                href="https://www.facebook.com/bettermati.org"
              ...
              <a
                href="https://www.linkedin.com/company/bettermati/"
                className="footer-social-btn"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="LinkedIn"
          ...
          <div className="footer-column">
            ...
            <ul className="footer-links-new">
              <li>
                <a href="https://quiz.bettermati.org/" target="_blank" rel="noopener noreferrer">
                  {t('footer-mati-quiz')}
                </a>
              </li>
              <li>
              ...
              <li>
                <a
                  href="https://mati.gov.ph/wp-content/uploads/2025/10/As-of-October-21-2025-2.pdf"
                  target="_blank"
                  rel="noopener noreferrer"
                >
          ...
          <div className="footer-column">
            ...
            <ul className="footer-links-new">
              ...
              <li>
                <a href="https://mati.gov.ph/" target="_blank" rel="noopener noreferrer">
                  {t('footer-lgu-portal')}
                </a>
              </li>
              <li>
                <a
                  href="https://sangguniangbayan.mati.gov.ph/"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  {t('footer-sb')}
              ...
              <li>
                <a
                  href="https://www.facebook.com/OfficialLguMatiFanpage/"
                  target="_blank"
                  rel="noopener noreferrer"
                >
          ...
          <div className="footer-column">
            ...
            <a href="mailto:volunteer@bettermati.org" className="footer-contribute">
